...
import { removeCommentsFromOtherChannels, removeDuplicates, sortByDate, removeDeleted } from '../utils/functions';
...
const chatroomReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.SET_CHANNELS:
      ...
      let channels = removeDeleted(uniqueChannels, action.payload.channelToDelete);
      return {
        ...state,
        channels: channels,
        channelError: action.payload.channelError
    ...
    case actionTypes.SET_COMMENTS:
      ...
      if (state.currentChannel) {
        ...
        comments = removeDeleted(sortedComments, action.payload.commentToDelete);
      }
